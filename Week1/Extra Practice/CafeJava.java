...
public class CafeJava {
    public static void main(String[] args) {
        ...
        double lattePrice = 6.45;
        double cappucinoPrice = 5.75;
        
        // Pascal Case
        double DripCoffeePrice = 0.25;
        double LattePrice = 0.45;
        double CappucinoPrice = 0.75;
        ...
        System.out.println(displayTotalMessage + df.format((lattePrice * 2)));
        ...
        System.out.println(displayTotalMessage + df.format(lattePrice - dripCoffeePrice));
    }
}
